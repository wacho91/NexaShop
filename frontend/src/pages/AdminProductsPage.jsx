...
export default function AdminProductsPage() {
  ...
  // El backend filtra por is_active; para listar activos e inactivos se hacen dos llamadas.
  ...
  const inputClass =
    'w-full border rounded-md px-3 py-2 dark:bg-gray-700 dark:border-gray-600';
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSave} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {error && (
                <div className="sm:col-span-2 bg-red-100 text-red-700 p-3 rounded-md text-sm">
                  {error}
                </div>
              )}
